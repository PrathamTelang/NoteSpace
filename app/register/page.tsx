...
function page() {
  return (
    <div className='w-screen h-screen flex justify-center items-center'>
        <div className=''>
            ...
            <div>
                ...
                <input type="text" placeholder='Enter your name' className='shadow text-sm shadow-gray-300 my-2 p-1 rounded w-full  focus:outline-none
    focus:ring-2
    ...
    focus:ring-gray-300 pl-2'/>
            ...
            <div>
                <button className='border p-1 pb-2 w-full bg-[#37383F] text-white rounded-lg cursor-pointer text-sm hover:bg-neutral-600'>Register</button>
            </div>
            <div className="w-full flex justify-center items-center text-sm text-gray-500">
